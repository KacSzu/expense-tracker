function Button({ children, type, onClick, variation, active, disabled }) {
  const base =
    "rounded-full  font-medium border focus:outline-none focus:ring  focus:ring-offset-2           disabled:cursor-not-allowed  ";
  const styles = {
    small: base + " px-4 py-2 md:px-5 md:py-4 text-xs",
    primary:
      base +
      "focus:ring-emerald-400 border-emerald-800 bg-emerald-200  hover:bg-emerald-300 focus:bg-emerald-300  px-3.5 py-2  md:px-5 md:py-3 lg:text-base sm:text-sm  ",
    ...
    danger:
      base +
      " px-3.5 py-2  md:px-5 md:py-3 border-red-800  bg-red-300 hover:bg-red-400 focus:bg-red-300   focus:ring-red-400 ",
  };
  return (
